...
export default function FurnitureControls() {
  ...
  return (
    <div className="absolute bottom-4 left-4 bg-white rounded-lg shadow-md z-10">
      ...
      {isOpen && (
        <div className="p-2">
          <div className="grid grid-cols-3 gap-1">
            ...
            {/* Up button (moves away from camera in 3D view) */}
            <button 
              className="p-2 hover:bg-gray-100 rounded" 
              onClick={moveUp}
              title="Move Forward"
            ...
            {/* Down button (moves toward camera in 3D view) */}
            <button 
              className="p-2 hover:bg-gray-100 rounded" 
              onClick={moveDown}
              title="Move Backward"
          ...
          <div className="mt-2 text-xs text-gray-500 text-center">
            Position: {selectedFurniture.position.x.toFixed(1)}m, {selectedFurniture.position.z.toFixed(1)}m
          </div>
        </div>
      )}
    </div>
